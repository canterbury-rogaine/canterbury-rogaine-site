...
<header class="site-header container">
  ...
  <nav aria-label="Main navigation"><a href="#events">The events</a><a href="#details">On the day</a><a href="#entry">Entry fees</a><a href="{{ '/reports/' | relative_url }}">Reports</a><a href="{{ '/results/' | relative_url }}">Results</a></nav>
...
<section class="hero container" aria-labelledby="hero-title">
  ...
  <div class="route-art" aria-hidden="true">
    <svg viewBox="0 0 500 540" xmlns="http://www.w3.org/2000/svg">
      <defs><pattern id="grid" width="40" height="40" patternUnits="userSpaceOnUse"><path d="M40 0H0V40" fill="none" stroke="#fff" stroke-opacity=".05"/></pattern></defs>
      <rect width="500" height="540" fill="url(#grid)"/>
      <g fill="none" stroke="#7c8b7a" opacity=".4"><path d="M-60 170C80 15 231 30 330 142S450 280 550 145M-60 190C80 35 223 48 316 157S450 302 550 170M-60 210C80 55 217 66 302 172S450 324 550 195M-60 230C80 75 209 84 288 187S450 346 550 220M-60 250C80 95 201 102 274 202S450 368 550 245M-60 270C80 115 193 120 260 217S450 390 550 270M-60 290C80 135 185 138 246 232S450 412 550 295M-60 310C80 155 177 156 232 247S450 434 550 320M-60 330C80 175 169 174 218 262S450 456 550 345M-60 350C80 195 161 192 204 277S450 478 550 370M-60 370C80 215 153 210 190 292S450 500 550 395M-60 390C80 235 145 228 176 307S450 522 550 420M-60 410C80 255 137 246 162 322S450 544 550 445M-60 430C80 275 129 264 148 337S450 566 550 470M-60 450C80 295 121 282 134 352S450 588 550 495"/></g>
      <path d="M115 378L188 235L338 282L385 132" fill="none" stroke="#ee5347" stroke-width="2" stroke-dasharray="7 7"/>
      <g fill="#26322e" stroke="#ee5347" stroke-width="3"><circle cx="115" cy="378" r="17"/><circle cx="188" cy="235" r="17"/><circle cx="338" cy="282" r="17"/><circle cx="385" cy="132" r="17"/></g>
      <g fill="#f5f1e8" font-family="system-ui" font-size="13" font-weight="700" text-anchor="middle"><text x="115" y="383">1</text><text x="188" y="240">2</text><text x="338" y="287">3</text><text x="385" y="137">4</text></g>
      <path d="M438 48V83M430 60L438 48L446 60" stroke="#f5f1e8" fill="none"/><text x="438" y="39" fill="#f5f1e8" font-family="system-ui" font-size="10" text-anchor="middle">N</text>
    </svg>
    <div class="art-topline">Leave the routine. Find your way.</div>
    <div class="art-caption"><span>43° S / 172° E</span><strong>A summer<br>well spent.</strong><span>Port Hills / Canterbury</span></div>
  </div>
</section>
...
<section id="entry" class="section container" aria-labelledby="entry-title">
  ...
  <div class="price-grid">
    ...
    <article class="price-card"><h3>Under 12</h3><p class="price">Free</p><p class="series-price">Must run with an adult over 18.</p></article>
  </div>
